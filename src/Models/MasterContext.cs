...
public partial class MasterContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            ...
            entity.HasIndex(e => e.Username, "UQ__Account__536C85E47E050459").IsUnique();
        ...
        modelBuilder.Entity<DeviceType>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__DeviceTy__737584F61AF5B9DB").IsUnique();
        ...
        modelBuilder.Entity<Person>(entity =>
        {
            ...
            entity.HasIndex(e => e.PassportNumber, "UQ__Person__45809E71A0B6C660").IsUnique();

            entity.HasIndex(e => e.PhoneNumber, "UQ__Person__85FB4E381DF45DF8").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Person__A9D10534467A34FE").IsUnique();
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Position__737584F68FCE0AED").IsUnique();
        ...
        modelBuilder.Entity<Role>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Role__737584F685930E86").IsUnique();
